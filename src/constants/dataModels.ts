...
export const WORDS = [
    {word: "Firm", number: 11},
    {word: "Support", number: 33},
    {word: "Inspiration", number: 64},
    {word: "Easily distracted", number: 24},
    {word: "Blunt", number: 41},
    {word: "Systems", number: 52},
    {word: "Possibilities", number: 34},
    {word: "Hesitant", number: 23},
    {word: "Decisive", number: 61},
    {word: "Critical", number: 22},
    {word: "Logical", number: 42},
    {word: "Take things to heart", number: 53},
    {word: "Inclusive", number: 43},
    {word: "Results", number: 51},
    {word: "Party animal", number: 44},
    {word: "Rational", number: 72},
    {word: "Bright", number: 14},
    {word: "Get to the point", number: 21},
    {word: "Fun", number: 54},
    {word: "Clear", number: 12},
    {word: "Patient", number: 73},
    {word: "Take action", number: 71},
    {word: "Patient", number: 73},
    {word: "Orderly", number: 62},
    {word: "Facts", number: 31},
    {word: "Calm", number: 13},
    {word: "Weigh up pros & cons", number: 32},
    {word: "Optimistic", number: 74},
    {word: "Feelings", number: 63},
